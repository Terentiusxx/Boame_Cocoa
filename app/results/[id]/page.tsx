      ...
      <div className="mobile-container">
        ...
        <div className="px-6 pb-6 flex flex-col h-full">
          ...
          <div className="flex items-center justify-between py-4 mb-6">
            <Link href="/scan" className="back-button">
              <span className="text-xl">‹</span>
            </Link>
            <h1 className="text-xl font-semibold text-title">Results</h1>
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center px-4">
            ...
            <h2 className="text-3xl font-bold text-title mb-4">Unknown</h2>
            
            <p className="text-sub-style leading-relaxed mb-8 max-w-xs">
              We cannot identify the disease your cocoa has. Please try again from a different angle.
            </p>
            
            <div className="w-full max-w-sm space-y-4">
              <Link href="/scan" className="green-button block">
                Try Again
              </Link>
              
              <Link href="/contact" className="green-button block bg-green-700">
                Contact Expert
              </Link>
            </div>
          </div>
    ...
    return (
      <div className="mobile-container">
        ...
        <div className="px-6 py-4">
          ...
          <Link href="/home" className="green-button mt-4 inline-block">
            Back to Home
          </Link>
        </div>
      </div>
    ...
    <div className="mobile-container">
      ...
      <div className="px-6 pb-6">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-title mb-2">{disease.name}</h2>
          <p className={`${disease.urgencyClass} text-lg font-semibold mb-4`}>{disease.urgency}</p>
          
          <div className="bg-gray-50 rounded-lg p-4 mb-6 text-left">
            <h3 className="font-semibold text-subtitle mb-2">Description:</h3>
            <p className="text-sub-style text-sm leading-relaxed mb-4">{disease.description}</p>
            
            <h3 className="font-semibold text-subtitle mb-2">Treatment:</h3>
            <p className="text-sub-style text-sm leading-relaxed">{disease.treatment}</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <Link href="/home" className="block w-full py-3 text-center text-hyperlink font-semibold">
              Back to Home
            </Link>
          </div>
        </div>
