/**
 * app/expert/profile/edit-profile/page.tsx
...
export default async function ExpertEditProfilePage() {
  ...
  try {
    ...
    // show form with empty values
  }

  return (
    <>
      <ExpertProfileClient initialProfile={profile} expertId={Number(expertId)} />
      <ExpertNavbar />
    </>
  );
}
