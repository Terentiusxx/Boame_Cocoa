...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      'Our AI model has been trained on thousands of cocoa plant images and achieves approximately 85-90% accuracy. However, results should be verified by agricultural experts.',
  },
  {
    question: 'What image quality is needed for best results?',
    answer:
      'For best results, use clear, well-lit photos taken from 6-12 inches away from the affected area. Avoid blurry or darkly lit images.',
  },
  {
    question: 'Can I use the app offline?',
    answer:
      'The app requires an internet connection for disease detection as processing is done on our servers. However, you can view your scan history offline.',
  },
  {
    question: 'How is my data protected?',
    answer:
      'All uploaded images and personal data are encrypted and stored securely. We follow industry-standard security practices to protect your information.',
  },
  {
    question: 'What diseases can the app detect?',
    answer:
      "Currently, the app can detect Black Pod Disease, CCVD, Vascular-Streak Dieback, and several other common cocoa diseases. We're continuously adding new disease types.",
  },
];
